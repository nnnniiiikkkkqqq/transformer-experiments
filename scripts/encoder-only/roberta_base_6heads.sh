#!/bin/bash
#SBATCH --job-name=roberta_base_6heads       # Название эксперимента
#SBATCH --output=../../logs/encoder-only/roberta_base_6heads/output.log  # Путь к логу вывода
#SBATCH --error=../../logs/encoder-only/roberta_base_6heads/error.log    # Путь к логу ошибок
...
python roberta_base_6heads.py

# Пример: Сохранение результатов
# cp model.pth ../../results/encoder-only/roberta_base_6heads/