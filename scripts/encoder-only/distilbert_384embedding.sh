#!/bin/bash
#SBATCH --job-name=distilbert_384embedding       # Название эксперимента
#SBATCH --output=../../logs/encoder-only/distilbert_384embedding/output.log  # Путь к логу вывода
#SBATCH --error=../../logs/encoder-only/distilbert_384embedding/error.log    # Путь к логу ошибок
...
python distilbert_384embedding.py

# Пример: Сохранение результатов
# cp model.pth ../../results/encoder-only/distilbert_384embedding/