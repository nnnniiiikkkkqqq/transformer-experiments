#!/bin/bash
#SBATCH --job-name=bert_384embedding       # Название эксперимента
#SBATCH --output=../../logs/encoder-only/bert_384embedding/output.log  # Путь к логу вывода
#SBATCH --error=../../logs/encoder-only/bert_384embedding/error.log    # Путь к логу ошибок
...
python bert_384embedding.py

# Пример: Сохранение результатов
# cp model.pth ../../results/encoder-only/bert_384embedding/