#!/bin/bash
#SBATCH --job-name=bert_base_6layers       # Название эксперимента
#SBATCH --output=../../logs/encoder-only/bert_base_6layers/output.log  # Путь к логу вывода
#SBATCH --error=../../logs/encoder-only/bert_base_6layers/error.log    # Путь к логу ошибок
...
python bert_base_6layers.py

# Пример: Сохранение результатов
# cp model.pth ../../results/encoder-only/bert_base_6layers/